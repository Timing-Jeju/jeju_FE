...
export const STABLE_PROBLEM_STATUSES: Record<string, readonly number[]> = {
  ...
  ASYNC_INTAKE_UNAVAILABLE: [503],
  ASYNC_RESULT_EXPIRED: [410],
  ASYNC_RESULT_TEMPORARILY_UNAVAILABLE: [503],
  ASYNC_RUN_NOT_FOUND: [404],
  AUTH_ACCESS_DENIED: [403],
  AUTHENTICATION_REQUIRED: [401],
  CANDIDATE_EXPIRED: [410],
  CANDIDATE_NOT_APPLICABLE: [422],
  CANDIDATE_NOT_FOUND: [404],
  CANDIDATE_STALE: [409],
  GENERATION_INPUT_CONSTRAINT_VIOLATION: [422],
